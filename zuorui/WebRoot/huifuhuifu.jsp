		...
		<div align="center">
			<div align="center" class="div2">
				<table align="center" width="100%" border="0" bgcolor="#C1C1C1"
					...
					<form action="/zuorui/huifuhuifuuser?huifuid=${requestScope.f.huifuid}&titleid=${requestScope.f.titleid}" method="post">
					<tr bgcolor="#FAFAFA">
									...
									<tr>
										...
										<td align="center" valign="middle">
											<input type="submit" value="回 复" />
											 <p align="right"><font size=1> <a href="/zuorui/xianshi2?titleid=${requestScope.f.titleid}"> 返回</a></font></p>
										</td>
									</tr>
								</table>
