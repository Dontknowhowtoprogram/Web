						...
						cellspacing="0">
										...
										<table border="0" width="750" align="center" cellpadding="0"
											...
											<tr>
												<td>
												   <div>
									<p align="right"><font size=1> <a href="/zuorui/xianshi?username=${sessionScope.username}"> 返回</a>&nbsp;&nbsp;<a href="/zuorui/allmail?username=${sessionScope.username}"> 历史站内信</a></font></p>
												      <ul>
												      <!-- 留言标题 -->
